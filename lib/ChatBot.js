...
class ChatBot extends Component {
  ...
  componentWillMount() {
    ...
    const defaultBotSettings = {
      ...
      bubbleOptionColor: bubbleOptionColor,
    ...
    if (options) {
      return (
        <OptionsStep
          ...
          step={step}
          triggerNextStep={this.triggerNextStep}
          bubbleOptionStyle={bubbleOptionStyle || bubbleStyle}
          bubbleOptionElementStyle={bubbleOptionElementStyle || bubbleStyle}
        />
      );
    }
...
ChatBot.propTypes = {
  ...
  bubbleOptionColor: PropTypes.string,
  optionFontColor: PropTypes.string,
  bubbleOptionElementStyle: PropTypes.object,
