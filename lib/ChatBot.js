...
import { Dimensions, TextInput, ScrollView, Platform, SafeAreaView } from 'react-native';
    ...
    if (options) {
      return (
        <OptionsStep
          ...
          step={step}
          triggerNextStep={this.triggerNextStep}
          bubbleStyle={{ ...bubbleStyle, ...userBubbleStyle }}
          fontSize={fontSize}
        />
      );
    }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <InputView behavior={platformBehavior} style={showInput ? {} : { height: 0 , opacity: 0 }}>
          <SafeAreaView>
            <Footer
